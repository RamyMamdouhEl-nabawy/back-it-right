...
const ProjectsList = (props) => {
  const { trigger, accessToken } = props;
  ...
  return (
    <div className="back-right row">
      ...
      <div
        className={`row ${
          trigger === false ? "d-none" : "d-initial"
        } text-start my-3`}
      >
        ...
        <span className="col-12 col-md-8">
          <input
            ...
            onChange={(e) => handleTimeJob(e.target)}
          />
        </span>
                ...
                <tr className="vertical-align-middle" key={index}>
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) => handleNewRepoPath(e.target)}
                    ></input>
                  </td>
                  <td>
                    <button
